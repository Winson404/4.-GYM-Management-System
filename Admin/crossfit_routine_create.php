  ...
  <div class="modal-dialog modal-dialog-scrollable">
    <div class="modal-content">
      <div class="modal-header bg-light">
        <h5 class="modal-title" id="staticBackdropLabel">Add new crossfit 1 performer</h5>
      ...
      <div class="modal-body">
        <div class="row">
          ...
          <div class="form-group mb-3">
            ...
            <?php
                $pro = mysqli_query($conn, "SELECT * FROM sub_program WHERE sub_program_name='Crossfit Wod'");
