  ...
  <?php unset($_SESSION['exists']); } ?>
            <!--#######################################################################################################################-->
                ...
                <div class="card-body">
                    ...
                    <table id="datatablesSimple">
                        ...
                        <tbody>
                            <?php
                               $i = 1;
                               include("../config.php");
                               $query ="SELECT * FROM bootcamp_routine2 JOIN sub_program ON bootcamp_routine2.routine2_sub_prog_Id=sub_program.sub_program_Id JOIN users ON bootcamp_routine2.guest_Id=users.user_Id";
                             ...
                             ?>
                              <tr>
                                  ...
                                  <?php 
                                      include 'bootcamp_routine2_update.php'; 
                                  ?>             
                            </tr>
                            <?php  
                                include 'bootcamp_routine2_delete.php';   
                               }    
                            ?>
                 ...
                 <?php include 'bootcamp_routine2_create.php'; ?>
            </div>
        </div>
    </main>
