<!-- Modal -->
<div class="modal fade" id="view_emp<?php echo $row['emp_Id']; ?>" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
      ...
      <div class="modal-body">
        ...
        <div class="row">
          ...
          <div class="col-md-4 mb-3">
            ...
            ?>
                <label>Gender</label>
                 <select class="form-control form-select" name="gender" required="" readonly>
