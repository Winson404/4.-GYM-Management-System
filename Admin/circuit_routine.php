  ...
  <?php unset($_SESSION['exists']); } ?>
            <!--#######################################################################################################################-->
                ...
                <div class="card-body">
                    ...
                    <table id="datatablesSimple">
                        ...
                        <tbody>
                            <?php
                               $i = 1;
                               include("../config.php");
                               $query ="SELECT * FROM circuit_routine1 JOIN sub_program ON circuit_routine1.routine_sub_prog_Id=sub_program.sub_program_Id JOIN users ON circuit_routine1.guest_Id=users.user_Id";
                             ...
                             ?>
                              <tr>
                                  ...
                                  <?php 
                                      include 'circuit_routine_update.php'; 
                                  ?>             
                            </tr>
                            <?php  
                                include 'circuit_routine_delete.php';   
                               }    
                            ?>
                 ...
                 <?php include 'circuit_routine_create.php'; ?>
            </div>
        </div>
    </main>
