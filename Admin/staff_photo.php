<!-- Modal -->
<div class="modal fade" id="emp_photo<?php echo $row['emp_Id']; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button type="submit" class="btn btn-primary" name="update_emp_photo"><i class="bi bi-save"></i>  Save</button>
      </div>
      </form>
    </div>
  </div>
