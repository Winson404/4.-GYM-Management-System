  ...
  <?php unset($_SESSION['exists']); } ?>
            <!--#######################################################################################################################-->
                ...
                <div class="card-body">
                    ...
                    <table id="datatablesSimple">
                        ...
                        <tbody>
                            <?php
                               $i = 1;
                               include("../config.php");
                               $query ="SELECT * FROM bootcamp_routine3 JOIN sub_program ON bootcamp_routine3.routine3_sub_prog_Id=sub_program.sub_program_Id JOIN users ON bootcamp_routine3.guest_Id=users.user_Id";
                             ...
                             ?>
                              <tr>
                                  ...
                                  <?php 
                                      include 'bootcamp_routine3_update.php'; 
                                  ?>             
                            </tr>
                            <?php  
                                include 'bootcamp_routine3_delete.php';   
                               }    
                            ?>
                 ...
                 <?php include 'bootcamp_routine3_create.php'; ?>
            </div>
        </div>
    </main>
