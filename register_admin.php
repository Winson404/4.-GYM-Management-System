        ...
        <div class="row justify-content-center">
          ...
          <div class="col-lg-11 mt-5 mt-lg-0 d-flex align-items-stretch rounded p-4 bg-light" style="border:1px solid lightgrey;">
            ...
            <!--   <div class="my-3">
              ...
              <div class="text-center mt-3"><button type="submit" class="btn btn-primary" name="register_employer">Register</button></div>
              <p>Already have an account? <a href="" data-bs-toggle="modal" data-bs-target="#employerlogin">Click here!</a></p>
            </form>
          </div>
